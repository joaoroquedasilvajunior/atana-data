...
ETLs: `etl/pnab__to_parquet.py` (Ciclo 1 + Ciclo 2 core; idempotent, byte-identical reruns; 4 source xlsx gitignored under `raw/pnab/_source/`) · `etl/pnab__ciclo1_avaliacao_headlines_to_parquet.py` (SNIIC seminar headline stats; inline data). Methodology: `docs/methodology/pnab_aldir_blanc.md`
